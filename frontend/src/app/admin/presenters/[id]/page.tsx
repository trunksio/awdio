...
export default function PresenterDetailPage() {
  ...
  // Edit KB image
  const [editingImage, setEditingImage] = useState<PresenterKBImage | null>(null);
  ...
  function openImageEditor(image: PresenterKBImage) {
  ...
  async function handleSaveImage() {
    ...
    try {
      setSavingImage(true);
      setError(null);
      await updatePresenterKBImage(presenterId, selectedKB, editingImage.id, {
